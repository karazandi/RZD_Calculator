...
def calc():
    ...
    if str(calc_opt_click.get()) == "Onshore Expansion Loop Calculator":
        ...
        reccommended_arm_length = math.ceil(minimumarmlength_design)

        exloop_total_expansion_design = customtkinter.CTkLabel(exloop_calc_result, text="Total Expansion (Design): ").grid(row=0, column=0)
        exloop_minarm_design = customtkinter.CTkLabel(exloop_calc_result, text="Minimum Required Arm Length (Design): ").grid(row=1, column=0)
        exloop_recommended_armlength = customtkinter.CTkLabel(exloop_calc_result, text="Recommended Arm Length (m): ").grid(row=2,  column=0)
        ...
        minarm_design = customtkinter.CTkLabel(exloop_calc_result, text=str(minimumarmlength_design) + " m").grid(row=1,column=1)
        recomm_arm = customtkinter.CTkLabel(exloop_calc_result, text=str(reccommended_arm_length) + " m").grid(row=2, column=1)
